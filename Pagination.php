    ...
    <div class="row">
        <div class="span12">
            <ul class="thumbnails listing-products">
                ...
                if(isset($_GET['page'])) {
                    $page = 6 * $_GET['page'];
                    $str = "select *from  products  LIMIT  $page";
                    $database = new Database();
                    $products = $database->getData($str);
                            ...
                            <li class="span3">
                                <div class="product-box">
                                    ...
                                    <a href="productDetails.php?id=<?php echo $productsRow['prod_id']; ?>"><img alt=""
                                                                                                                ...
                                                                                                                height="30%"
                                                                                                                width="20%"></a><br/>
                                    <a href="productDetails.php?id=<?php echo $productsRow['prod_id']; ?>"
                                       class="title"><?php echo $productsRow['prod_name']; ?></a><br/>
                                    <?php
